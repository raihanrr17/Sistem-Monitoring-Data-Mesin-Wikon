...
<head>
  ...
  <title>Dashboard Availability Mesin - Admin</title>
...
<body>
    ...
    <main class="main-content">
      <header class="main-header">
        <div>
          ...
          <p>Monitoring availability mesin per bulan (Admin View)</p>
        </div>
      ...
      <section class="panel" style="margin-bottom: 20px; padding: 15px 25px;">
        <div style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
          <h2 style="font-size: 16px; margin: 0; color: #1e3a8a; font-weight: 700;">Filter Periode Grafik:</h2>
      ...
      <section class="summary-grid">
        <div class="summary-card summary-primary">
          <h3 id="summaryMonthYear">Total Mesin - Belum Ada Data</h3>
      ...
      <section style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px; margin-bottom: 24px;">
        ...
        <div class="panel mini-panel center" style="padding: 16px;">
          <h3 style="color: #1e3a8a; border-bottom: 1px solid #e5e7eb; padding-bottom: 10px; margin-bottom: 14px; font-size: 16px;">Die Casting (DC)</h3>
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="flex: 1;">
              <p style="font-size: 11px; color: #6b7280; font-weight: 800; text-transform: uppercase;">Tertinggi</p>
              <div class="big-value" id="dcMaxVal" style="font-size: 26px; color: #16a34a; margin: 6px 0;">0%</div>
              <span id="dcMaxMesin" style="background: #dcfce7; color: #16a34a; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 700;">-</span>
            </div>
            <div style="width: 1px; height: 50px; background: #e5e7eb;"></div>
            <div style="flex: 1;">
              <p style="font-size: 11px; color: #6b7280; font-weight: 800; text-transform: uppercase;">Terendah</p>
              <div class="big-value" id="dcMinVal" style="font-size: 26px; color: #dc2626; margin: 6px 0;">0%</div>
              <span id="dcMinMesin" style="background: #fee2e2; color: #dc2626; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 700;">-</span>
            </div>
          </div>
        </div>

        <div class="panel mini-panel center" style="padding: 16px;">
          <h3 style="color: #1e3a8a; border-bottom: 1px solid #e5e7eb; padding-bottom: 10px; margin-bottom: 14px; font-size: 16px;">Gravity Casting (GC)</h3>
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="flex: 1;">
              <p style="font-size: 11px; color: #6b7280; font-weight: 800; text-transform: uppercase;">Tertinggi</p>
              <div class="big-value" id="gcMaxVal" style="font-size: 26px; color: #16a34a; margin: 6px 0;">0%</div>
              <span id="gcMaxMesin" style="background: #dcfce7; color: #16a34a; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 700;">-</span>
            </div>
            <div style="width: 1px; height: 50px; background: #e5e7eb;"></div>
            <div style="flex: 1;">
              <p style="font-size: 11px; color: #6b7280; font-weight: 800; text-transform: uppercase;">Terendah</p>
              <div class="big-value" id="gcMinVal" style="font-size: 26px; color: #dc2626; margin: 6px 0;">0%</div>
              <span id="gcMinMesin" style="background: #fee2e2; color: #dc2626; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 700;">-</span>
            </div>
          </div>
        </div>

        <div class="panel mini-panel center" style="padding: 16px;">
          <h3 style="color: #1e3a8a; border-bottom: 1px solid #e5e7eb; padding-bottom: 10px; margin-bottom: 14px; font-size: 16px;">Sand Blowing (SB)</h3>
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="flex: 1;">
              <p style="font-size: 11px; color: #6b7280; font-weight: 800; text-transform: uppercase;">Tertinggi</p>
              <div class="big-value" id="sbMaxVal" style="font-size: 26px; color: #16a34a; margin: 6px 0;">0%</div>
              <span id="sbMaxMesin" style="background: #dcfce7; color: #16a34a; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 700;">-</span>
            </div>
            <div style="width: 1px; height: 50px; background: #e5e7eb;"></div>
            <div style="flex: 1;">
              <p style="font-size: 11px; color: #6b7280; font-weight: 800; text-transform: uppercase;">Terendah</p>
              <div class="big-value" id="sbMinVal" style="font-size: 26px; color: #dc2626; margin: 6px 0;">0%</div>
              <span id="sbMinMesin" style="background: #fee2e2; color: #dc2626; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 700;">-</span>
            </div>
          </div>
        </div>

        <div class="panel mini-panel center" style="padding: 16px;">
          <h3 style="color: #1e3a8a; border-bottom: 1px solid #e5e7eb; padding-bottom: 10px; margin-bottom: 14px; font-size: 16px;">Mesin CNC</h3>
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="flex: 1;">
              <p style="font-size: 11px; color: #6b7280; font-weight: 800; text-transform: uppercase;">Tertinggi</p>
              <div class="big-value" id="cncMaxVal" style="font-size: 26px; color: #16a34a; margin: 6px 0;">0%</div>
              <span id="cncMaxMesin" style="background: #dcfce7; color: #16a34a; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 700;">-</span>
            </div>
            <div style="width: 1px; height: 50px; background: #e5e7eb;"></div>
            <div style="flex: 1;">
              <p style="font-size: 11px; color: #6b7280; font-weight: 800; text-transform: uppercase;">Terendah</p>
              <div class="big-value" id="cncMinVal" style="font-size: 26px; color: #dc2626; margin: 6px 0;">0%</div>
              <span id="cncMinMesin" style="background: #fee2e2; color: #dc2626; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 700;">-</span>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    function renderMainChart(labels, values) {
      const existingChart = Chart.getChart("availabilityChart");
    ...
    function updateDashboardUI(month, year) {
      const filteredData = rawData.filter(d => d.bulan === month && String(d.tahun) === String(year));
      ...
      document.getElementById("totalMesinSummary").textContent = filteredData.length;

      const activeAll = filteredData.filter(d => parseFloat(d.loading_time) > 0);
      ...
      document.getElementById("totalBreakdownSummary").textContent = filteredData.reduce((s, i) => s + parseInt(i.freq_breakdown), 0);
      ...
      plants.forEach(plant => {
        const pData = filteredData.filter(d => d.plant === plant);
        ...
        if (pActive.length > 0) {
          ...
          chartValues.push(parseFloat(avgPlant));
          chartLabels.push([plant, avgPlant + "%"]);
    ...
    fetch('/api/machines')
      ...
      .then(data => {
        ...
        if (rawData.length > 0) {
          ...
          const monthsInLatestYear = data.filter(d => String(d.tahun) === String(latestYear)).map(d => d.bulan);
          const latestMonth = monthOrder.filter(m => monthsInLatestYear.includes(m)).pop();
    ...
    document.getElementById("btnApplyFilter").addEventListener("click", () => {
      const m = document.getElementById("dashMonthFilter").value;
      const y = document.getElementById("dashYearFilter").value;
      updateDashboardUI(m, y);
    });

    const trendCtx = document.getElementById("trendChart");
    if (trendCtx) {
        new Chart(trendCtx, { type: 'line', data: { labels: ["Okt", "Nov", "Des", "Jan", "Feb", "Mar"], datasets: [{ label: "Trend", data: [91, 92, 94, 93, 95, 96], borderColor: "#2563eb", fill: true, backgroundColor: "rgba(37,99,235,0.1)", tension: 0.4 }] }, options: { responsive: true, maintainAspectRatio: false }});
    }
    const breakdownCtx = document.getElementById("breakdownChart");
    if (breakdownCtx) {
        new Chart(breakdownCtx, { type: 'line', data: { labels: ["Okt", "Nov", "Des", "Jan", "Feb", "Mar"], datasets: [{ label: "Freq", data: [14, 12, 10, 9, 8, 12], borderColor: "#f59e0b", fill: true, backgroundColor: "rgba(245,158,11,0.1)", tension: 0.4 }] }, options: { responsive: true, maintainAspectRatio: false }});
    }
  </script>
</body>
</html>